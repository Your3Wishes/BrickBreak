...
public class FallingBrick extends Brick {
    ...
    private int spawnToWiggleDuration = 2000; // Duration from spawn to when the brick starts to wiggle
    private int wiggleToFallDuration = 3000; // Druation from wiggle to when the brick starts to falling
